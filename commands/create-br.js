	...
	collector.on('end', async (msgs, reason) => {
		if (reason == 'DONE') {
			const embed = new Discord.MessageEmbed()
				.setTitle('Sauga Reaction Roles || Pings')
        .setImage('https://cdn.discordapp.com/attachments/841108445825466399/880407859135938631/Hnet-image_7.gif')
				.setDescription('Click on the buttons to get a specific Pings!')
				.setColor('RANDOM')
				.setTimestamp();
